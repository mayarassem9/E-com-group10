...
export function samePass(currentUser) {
  if (
    document.getElementById("newPassword").value === currentUser[0].password
  ) {
    var span = document.getElementById("oldPasswordSpan");
    span.style.display = "";
    span.innerText = "please choose new password ";
    return false;
  } else {
    return true;
  }
...
export function oldPass(currentUser) {
  ...
  if (currentUser[0].password == oldPassword) return true;
  else {
    var span = document.getElementById("oldPasswordSpan");
    span.style.display = "";
